...
const withHotwords = buildOmniInstructions({
	apiKey: "test",
	model: "qwen3.5-omni-plus-realtime",
	mode: "structure",
	app: "飞书",
	hotWords: ["InputSurface", "金秋"],
});
assert.match(withHotwords, /InputSurface/);
assert.match(withHotwords, /金秋/);
